...
var enableOffline = require('./modules/offline');
var notification = require('./modules/notification');
var renderMonthlyCalendars = require('./modules/calendar');
var initMenu = require('./modules/menu');
...
}).then(notification).then(renderMonthlyCalendars).catch(handleError);

},{"./modules/calendar":6,"./modules/menu":7,"./modules/notification":8,"./modules/offline":9}],6:[function(require,module,exports){
'use strict';
...
module.exports = function (monthlyCalendar) {
    return new Promise(function (resolve, reject) {
        try {
            calendarElement.insertAdjacentHTML('beforeend', '<h1 class="black-alternative f3 f2-ns mv0 normal pb4 pt5 tc">Calendario de eventos</h1>');
            ...
            monthlyCalendar.forEach(function (calendar) {
                ...
                if (currentMonth.isoWeekday() !== 7) {
                    for (var i = currentMonth.isoWeekday(); i > 0; i--) {
                        gridElement.insertAdjacentHTML('beforeend', '<div class="b--black-10 bb bg-near-white bl bw1 dn db-l w-one-seventh-l">\n                            </div>');
                    }
                }
                ...
                calendar.events.forEach(function (event) {
                    var eventDay = moment(event.date).utc();
...
},{"isomorphic-fetch":1,"moment":3,"moment/locale/es":2}],7:[function(require,module,exports){
'use strict';
...
var bellElement = document.querySelector('.bell');

var storage = {};

var disableNotifications = function disableNotifications() {
    bellElement.classList.remove('active');
    clearTimeout(storage.notification);
};

var enableNotifications = function enableNotifications(months) {
    bellElement.classList.add('active');
    var event = months[0].events[0];
    var diff_millis = moment(event.date).diff(moment()).valueOf();
    var restante = moment.duration(diff_millis).humanize();
    ...
    bellElement.addEventListener('click', function () {
        if ('Notification' in window) {
            Promise.resolve(Notification.permission).then(function (perm) {
                ...
                bellElement.classList.contains('active') ? disableNotifications() : enableNotifications(months);
            }).catch(function (err) {
                // eslint-disable-next-line no-console
                console.log('err', err);
            });
...
},{"moment":3,"moment/locale/es":2}],9:[function(require,module,exports){
'use strict';
...
},{"./toast.js":10}],10:[function(require,module,exports){
'use strict';
